...
void updateMatrixFloat(
	cell matrix[MATRIX_WIDTH][MATRIX_HEIGHT],
	int matrixX1, 
	int matrixY1, 
	int matrixX2, 
	int matrixY2
...
void onKeyboardPress(int key, int x, int y) {
	switch(key) {
    case 27:
			exit(0);
			break;
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("Line Rasterization");
